...
async function _fetchWithAuth(allowRefresh: boolean, cookies: Cookies,
    relativeUrl: URL | string, method: string, headers?: HeadersInit, body?: Object): Promise<Response> {
...
export async function fetchWithAuth(cookies: Cookies, relativeUrl: URL | string,
