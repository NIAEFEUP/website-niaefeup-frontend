...
<section class="min-h-screen pt-60 font-raleway">
  ...
  <div class="mt-28 text-center">
    <strong class="text-5xl text-white">A <em class="font-normal">FEUP</em> no teu bolso</strong>
  </div>
  ...
  <div class="mt-32 flex items-center justify-center gap-4">
    <img
      ...
      src="/images/uni/showcase.png"
      alt="Three printscreens of phones showcasing the uni app"
    />
    <p class="w-1/3 max-w-xl text-right text-4xl text-gray-100">
      facilitar e tornar mais rápido o acesso a informações da plataforma da faculdade, bem como de
      outros serviços que possam interessar aos estudantes da mesma.
    </p>
  </div>
    ...
    <div class="flex w-1/3 flex-col items-center">
      ...
      <div class="mt-6 flex justify-center gap-8">
        <p class="text-center text-3xl font-semibold text-white">
          Todos os estudantes da Universidade do Porto.
        </p>
      </div>
    </div>
  </div>
