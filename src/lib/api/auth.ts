...
export function appendSetCookieHeader(response: Response, name: string, value: string) {
...
export function appendDestroyCookieHeader(response: Response, name: string) {
