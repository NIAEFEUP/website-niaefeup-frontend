<script lang="ts">
  ...
  onMount(() => {
    ...
    const icons: NodeListOf<HTMLElement> | null = target.querySelectorAll('.icon');
...
<Hexagon {orientation}>
  ...
  >
    <div
      class="container absolute bottom-0 z-20 w-full px-4 duration-500 group-hover:bottom-1/2 group-hover:translate-y-1/2"
    >
      <p
        class="mx-auto w-[70%] text-center text-sm font-bold leading-tight text-gray-100 transition-all sm:text-sm md:text-sm lg:text-base xl:text-xl 2xl:text-2xl"
      >
        {teamMember.name}
      </p>
      <p
        class="full-opacity mx-auto text-center text-xs leading-tight text-gray-100 opacity-0 transition-all duration-500 ease-out group-hover:opacity-100 sm:text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-2xl"
      >
        {teamMember.role}
      </p>
        ...
        <div class="absolute w-full flex justify-center gap-2">
          {#if teamMember.linkedin}
            <a
              ...
              class="icon h-6 full-opacity opacity-0 transition-all duration-500 ease-out group-hover:opacity-100"
          ...
          {#if teamMember.gitHub}
            <a
              ...
              class="icon h-6 full-opacity opacity-0 transition-all duration-500 ease-out group-hover:static group-hover:opacity-100"
          ...
          {#if teamMember.websites}
            {#each teamMember.websites as customWebsite}
              <a
                ...
                class="h-6 full-opacity opacity-0 transition-all duration-500 ease-out group-hover:opacity-100"
