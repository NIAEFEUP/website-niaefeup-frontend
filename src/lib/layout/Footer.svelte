...
<div class="w-full bg-transparent p-3 max-sm:hidden z-10">
  <footer class="p-2 text-white grid grid-cols-3 justify-between border-t-2 border-secondary">
    <div class="flex p-3 self-center gap-3">
      <a href="https://www.instagram.com/niaefeup/"
        ><Icon src={FaBrandsInstagram} color="white" size="24px" /></a
      >
      <a href="https://twitter.com/niaefeup"
        ><Icon src={FaBrandsTwitter} color="white" size="24px" /></a
      >
      <a href="https://www.facebook.com/NIAEFEUP"
        ><Icon src={FaBrandsFacebook} color="white" size="24px" /></a
      >
      <a href="https://github.com/NIAEFEUP"
        ><Icon src={FaBrandsGithub} color="white" size="24px" /></a
      >
      <a href="https://www.linkedin.com/company/nifeup"
        ><Icon src={FaBrandsLinkedin} color="white" size="24px" /></a
      >
