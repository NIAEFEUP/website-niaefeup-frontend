...
<div class="flex flex-col items-center justify-center gap-y-2">
  ...
  <button
    ...
    class="bg-muted-red-400 relative flex h-[200px] w-[200px] items-center justify-center rounded-md text-center"
    onclick={() => {
      fileInput.click();
    }}
  >
    ...
    {/if}
    <div
      class="absolute right-0 bottom-0 m-2 flex h-[15%] w-[15%] cursor-pointer items-center justify-center rounded-md bg-rose-950"
    >
